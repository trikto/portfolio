...
export const metadata: Metadata = pageMetadata({ title: "Reveal a One-Time Secret", description: "Open a one-time encrypted secret link. The stored copy is deleted the moment it is read.", path: "/clipboard", noIndex: true });
  ...
  return (
    <main id="site-top" className="site concept-cloud secret-page">
      ...
      <section className="secret-hero" aria-labelledby="secret-reveal-title">
        <p className="eyebrow">DEVOPS UTILITIES / <Link href="/clipboard">ONE-TIME SECRETS</Link></p>
      ...
      <footer className="secret-footer">One read, then the stored copy is gone · <Link href="/clipboard">Create your own one-time secret</Link></footer>
    </main>
  );
}
