...
const tools = [
  ...
  { title: "Encrypted File Sharing", description: "Share a file of up to 100 MB as an encrypted link. Encrypted in your browser, with the decryption key in the URL fragment. The sender pays a one-time mobile charge.", action: "Encrypted File Sharing", href: "/files", icon: "▤" },
];
