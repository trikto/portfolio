...
export const metadata: Metadata = pageMetadata({ title: "Download an Encrypted File", description: "Open an encrypted file link. The file is decrypted in your browser using the key in the URL fragment.", path: "/files", noIndex: true });
  ...
  return (
    <main id="site-top" className="site concept-cloud secret-page">
      ...
      <section className="secret-hero" aria-labelledby="file-download-title">
        <p className="eyebrow">DEVOPS UTILITIES / <Link href="/files">ENCRYPTED FILES</Link></p>
