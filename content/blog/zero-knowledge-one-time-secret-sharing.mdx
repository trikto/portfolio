...
For a file of up to 100 MB that should stay reusable, EncryFy lives at [gajan.dev/files](/files). The design notes are in [Building EncryFy, a Zero-Knowledge Encrypted File Sharing Tool](/blog/encryfy-zero-knowledge-file-sharing).
