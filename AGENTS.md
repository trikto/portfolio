...
- The requested Vercel reconnect and GitHub deletion are pending authentication: Vercel CLI has no credentials, and the GitHub token lacks the `delete_repo` scope.
